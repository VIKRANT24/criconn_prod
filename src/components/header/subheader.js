...
//img
import topHeader from '../../assets/images/home/headerbg.jpg'
        ...
        <Fragment>
            <div className="iq-navbar-header" style={{height: "215px"}}>
                ...
                <div className="iq-header-img">
                    <img src={topHeader} alt="header" style={{marginTop:'50px'}} className=" img-fluid w-100 h-100 "/>
                </div>
            </div>
        </Fragment>
    )
